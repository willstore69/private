...
#
sed -i "s#^[[:space:]]*location ~\* ^/(a|b|c|d|e|f|g|h|i|j|k|l|m|n|p|q|r|sa|t|u|vmessws|w|x|y|z)#    location ~* ^/(a|b|c|d|e|f|g|h|i|j|k|l|m|na|nu|ni|ne|p|q|r|sa|t|u|vmessws|w|x|y|z)#" /etc/nginx/conf.d/vmnone.conf
